...
pubDate: 2023-08-14
image: "../../assets/images/blog/washington-cares-payroll-tax.png"
---
...
## What Is the Washington Cares Tax?
...
The good part is that people now live for a couple of years _after  _being out of work for some time. 
...
## How Will Workers Benefit From the Washington Cares Tax?
...
The raft of long-term care services eligible contributors in the state will be able to access include —
  ...
  * **Payment for qualified home care:  **The fund will pay the cost of care offered by a qualified care provider. Many will be happy to learn that these include care provided by a qualified family member, including a spouse.
  * **Payment for assistive equipment:  **The Washington Cares Tax will help pay for equipment that helps improve contributors’ mobility, among other considerations. These include wheelchairs and scooters.
  * **Payment for food delivery services:  **Since contributors may reach a point where they cannot cook or go to a restaurant, the fund will pay for meal delivery services.
  * **Payment for care supplies: I** ncludes payments for items such as adult diapers, nebulizer kits (inhalers used for certain respiratory conditions), and wound care.
...
## What the Washington Care Tax Means For Your Payroll
...
![](/wp-content/uploads/2025/06/6747083ff641582987466b78_64dba7dc86380df2dd8fa8fa_Chart.png)
...
Other employer responsibilities related to Washington Care Fund exemptions include putting systems in place for—
  ...
  * Collecting exemption approval letters from employees and retaining copies of the same.
  * Receiving notices from workers who no longer qualify for an exemption, and
  * Resuming payroll deductions if notified that a worker no longer qualifies for an exemption.

To recap, the Washington Care Tax will affect your payroll in the following ways.

  * You’ll need to withhold an uncapped 0.58% from the gross salary of your workers every month beginning July 1, 2023.
  * You’ll need to make quarterly returns to the Employment Security Department (ESD), and the returns should be accompanied by the withheld deductions.
  * You’ll need to effect any exemptions that employees have been awarded by the ESD file copies of the exemption letters for record-keeping purposes. 
